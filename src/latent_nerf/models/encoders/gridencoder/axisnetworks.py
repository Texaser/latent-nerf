...
class MultiScaleTriplane_Pooling(nn.Module):
    def __init__(self, input_dim=3, n_scales=3, iteration=0, channel=96):
        super().__init__()
        self.input_dim = input_dim
        self.output_dim = channel 
        self.n_scales = n_scales

        self.plane_x1 = nn.Parameter(torch.randn(1, channel, 256, 256) * 0.001)
        self.plane_y1 = nn.Parameter(torch.randn(1, channel, 256, 256) * 0.001)
        self.plane_z1 = nn.Parameter(torch.randn(1, channel, 256, 256) * 0.001)
